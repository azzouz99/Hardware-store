<div class="relative bg-gradient-to-r from-[#2d2d2d] to-[#3f3f3f]">
    ...
    <div class="container mx-auto relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 py-12 px-4">
            <!-- Location Section -->
            <div class="space-y-4">
                <h3 class="font-bold text-lg text-[#d4af37] uppercase tracking-wide flex items-center gap-2">
            ...
            <div class="space-y-4">
                <h3 class="font-bold text-lg text-[#d4af37] uppercase tracking-wide flex items-center gap-2">
                    ...
                    Horaires point de vente
                </h3>
                <div class="text-gray-300 space-y-2">
                    <p class="font-semibold text-[#d4af37]">7 Jours sur 7</p>
                    <div class="space-y-1 ml-4">
                        <p>Du Lundi Au Samedi : 07:30 à 18:45</p>
                        <p>Vendredi : 07:30-12:00 à 14:00-18:45</p>
                        <p>Dimanche : 07h30 à 14h00</p>
                    </div>
                    
                    <div class="mt-4 space-y-1">
                        <h4 class="font-semibold text-[#d4af37] flex items-center gap-2">
                        ...
                        <p class="ml-6">Entre 24h et 72h</p>
                        <p class="ml-6">sur toute la Tunisie</p>
                    </div>
                </div>
            </div>
        </div>
